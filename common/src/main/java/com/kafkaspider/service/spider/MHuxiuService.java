...
@Service
@Slf4j
public class MHuxiuService implements ContentService, MatchService, CleanService {
    public static final String[] patterns = new String[]{
            "https://m.huxiu.com/article/(.+)",
            "http://m.huxiu.com/article/(.+)"
    };
    ...
    public void wait(WebDriver chrome, String url) {
        ...
        WebElement searchInput = wait.until(new ExpectedCondition<WebElement>() {
            ...
            public WebElement apply(WebDriver text) {
                return text.findElement(By.id("article-detail-content"));
            }
        });
    ...
    public String getMainContent(WebDriver chrome, String url) {
        WebElement content = chrome.findElement(By.id("article-detail-content"));
        String ans = "";
        if (content == null) {
    ...
    public String getTitle(WebDriver chrome, String url) {
        WebElement article = chrome.findElement(By.id("article"));
        WebElement title = article.findElement(By.className("title"));
        if(title==null){
            log.error("getTitle error: No WebElement");
            return "";
        }
    ...
    public Date getTime(WebDriver chrome, String url) {
        WebElement time = chrome.findElement(By.className("m-article-time"));
