...
@Service
@Slf4j
public class HuxiuService implements ContentService, MatchService, CleanService {
    ...
    public void wait(WebDriver chrome, String url) {
        ...
        WebElement searchInput = wait.until(new ExpectedCondition<WebElement>() {
            ...
            public WebElement apply(WebDriver text) {
                return text.findElement(By.id("article-content"));
            }
        });
    ...
    public String getMainContent(WebDriver chrome, String url) {
        WebElement content = chrome.findElement(By.id("article-content"));
        String ans = "";
        if (content == null) {
    ...
    public String getTitle(WebDriver chrome, String url) {
        WebElement content = chrome.findElement(By.className("article__title"));
